 ...
 *  @file tqdm.h
 * 
 *  @brief A C++ progress bar library inspired by tqdm
 *  @details shamelessly copied from https://github.com/cmstas/NanoTools/blob/ff324837f233465699920684a650455a6f3667e2/NanoCORE/tqdm.h  
 * 
 *  @authors cmstas 2018-2020
 * 
 *  @author namin 2018-2019
 *  @author sgnoohc 2020
 *  @author jkguiang 2020
*/
#ifndef TQDM_H
#define TQDM_H
#include <algorithm>
